...
namespace RTSEngine
{
    ...
    {
        public static AttackWarningManager instance; //only one instance of this component is allowed per game.
        ...
        [SerializeField]
        private bool showUIMessage = true; //show UI message when attacked
            ...
            if (CanAddAttackWarning(Source.transform.position))
            {
                ...
                { //making sure we have a valid attack warning
                    ...
                    if (showUIMessage == true)
                        UIManager.instance.ShowPlayerMessage("Your unit(s)/building(s) are under attack!", UIManager.MessageTypes.Info);
