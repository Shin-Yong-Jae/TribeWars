...
/* Attack Object Launcher script created by Oussama Bouanani, SoumiDelRio.
...
namespace RTSEngine
{
    ...
    public class AttackObjectLauncher
    {
        ...
        public class Source
        {
            ...
            public void Launch (AttackEntity source)
            {
                AttackObject newAttackObject = EffectObjPool.SpawnEffectObj(attackObject, launchPosition.position, Quaternion.identity).GetComponent<AttackObject>();

                Vector3 targetPosition = source.Target.GetSelection().transform.position;
                ...
                newAttackObject.Init(source, targetPosition,
        ...
        public void Init (AttackEntity source)
        {
            this.source = source;
        }
        ...
        public bool OnIndirectAttackUpdate ()
        {
            ...
            else
            {
                ...
                //not an area attack:
                CustomEvents.instance.OnAttackPerformed(source, source.Target);

                sources[sourceStep].Launch(source);
