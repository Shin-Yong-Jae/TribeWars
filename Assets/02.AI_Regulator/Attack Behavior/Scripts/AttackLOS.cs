...
namespace RTSEngine
{
    ...
    public class AttackLOS
    {
        ...
        public bool IsActive { set; get; } //is the attack entity in line of sight of the target?
        ...
        {
            if (enable == false || IsActive == true) //if this is not enabled or the attacker already entered in sight of the target, true!
                return true;
            ...
            IsActive = Vector3.Angle(transformRef.forward, lookAt) <= LOSAngle;
            return IsActive;
        }
    }
}
