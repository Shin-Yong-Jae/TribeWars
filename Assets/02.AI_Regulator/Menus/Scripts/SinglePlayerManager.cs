...
namespace RTSEngine
{
	public class SinglePlayerManager : MonoBehaviour {
        ...
        //defeat condition:
        public DefeatConditionMenu defeatConditionMenu = new DefeatConditionMenu(); //the player pick the defeat condition for the game using this menu

        public SpeedModifierMenu speedModifierMenu = new SpeedModifierMenu(); //the player can pick the speed modifier using this menu
        ...
        void Awake () {
			...
			if (Maps.Length > 0) {
                ...
                //initialize the defeat condition & speed modifier menu
		...
		public void AddFaction () {
			...
			if (Factions.Count < Maps [CurrentMapID].MaxFactions) {
                ...
                NewFaction.FactionColor = AllowedColors[0];
                ...
                if (Factions.Count == 0) //first faction to be created -> player faction
                {
                    ...
                    //so that we have a different color for the first two factions in the menu
                    NewFaction.FactionColor = AllowedColors[1];
                    NewFaction.FactionColorID = 1;
