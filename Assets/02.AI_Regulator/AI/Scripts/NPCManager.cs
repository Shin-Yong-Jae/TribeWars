...
namespace RTSEngine
{
    public class NPCManager : MonoBehaviour
    {
        ...
        public NPCBuildingUpgradeManager buildingUpgradeManager_NPC { get; private set; }

        public NPCUnitCreator unitCreator_NPC { get; private set; }
        public NPCUnitUpgradeManager unitUpgradeManager_NPC { get; private set; }
        ...
        public void Init()
        {
            ...
            foreach(Transform child in this.transform)
            {
                ...
                if (child.GetComponent<NPCBuildingUpgradeManager>())
                {
                    buildingUpgradeManager_NPC = child.GetComponent<NPCBuildingUpgradeManager>();
                    buildingUpgradeManager_NPC.InitManagers(this, FactionMgr);
                }
                ...
                if(child.GetComponent<NPCUnitUpgradeManager>())
                {
                    unitUpgradeManager_NPC = child.GetComponent<NPCUnitUpgradeManager>();
                    unitUpgradeManager_NPC.InitManagers(this, FactionMgr);
                }
