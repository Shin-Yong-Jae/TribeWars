...
namespace RTSEngine
{
    public class NPCBuildingConstructor : NPCComponent
    {
        ...
        //activates the builder regulator
        public void ActivateBuilderRegulator ()
        {
            ...
            else
            {
                ...
                Debug.LogError("[NPC Building Constructor] NPC Faction ID: " + factionMgr.FactionID + " NPC Building Constructor component doesn't have a builder regulator assigned!");
            }
        }
