...
namespace RTSEngine
{
    ...
    public class NPCBuildingRegulator : NPCRegulator<Building>
    {
        ...
        public bool rotate = false; //when true, the building will rotate to look at its placement around object
        ...
        {
            return (building.FactionID == factionMgr.FactionID && building.GetCode() == code || currentInstances.Contains(building)) && buildingCenter == building.CurrentCenter.building;
        }
