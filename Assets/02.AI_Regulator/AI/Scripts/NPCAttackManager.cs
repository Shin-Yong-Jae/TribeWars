...
namespace RTSEngine
{
    public class NPCAttackManager : NPCComponent
    {
        ...
        void SetTargetBuilding ()
        {
            ...
            while (i < targetFaction.Buildings.Count)
            {
                ...
                if (targetFaction.Buildings[i] != null)
                {
                    ...
                    if (targetBuildingCodes.Contains(targetFaction.Buildings[i].GetCode()))
                    {
        ...
        void AttackTargetBuilding ()
        {
            ...
            FactionEntity target = currentTargetBuilding;
            ...
            if(currentTargetBuilding.WorkerMgr.currWorkers > 0)
            {
                Unit[] workersList = currentTargetBuilding.WorkerMgr.GetAll(); //get all workers in the worker manager
            ...
            MovementManager.instance.LaunchAttack(currentAttackUnits, target, attackMode, false);
        }
